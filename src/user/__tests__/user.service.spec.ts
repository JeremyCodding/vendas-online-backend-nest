...
describe('UserService', () => {
  ...
  it('should return an user in findUserByEmail', async () => {
  ...
  it('should return an error in findUserByEmail(error request on DB)', async () => {
  ...
  it('should return an user in findUserById', async () => {
  ...
  it('should return an user in getUserByIdUsingRelations', async () => {
    const user = await service.findUserById(userEntityMock.id);
  ...
  it('should return the user if it does not exists', async () => {
